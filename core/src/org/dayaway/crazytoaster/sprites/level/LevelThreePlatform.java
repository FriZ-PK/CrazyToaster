...
public class LevelThreePlatform extends Level {

    public LevelThreePlatform(int levelCount) {

        //Инициализируем уровень тут
        super (new Toaster(new Floor(CrazyToaster.textures.floor_three, 100, levelCount * LevelManager.LEVEL_GAP),

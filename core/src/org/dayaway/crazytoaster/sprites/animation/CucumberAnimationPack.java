...
public class CucumberAnimationPack implements AnimationPack {
    ...
    private final Texture emptyToasterTextureRight = new Texture("empty_cucumber_toaster_animation_right.png");
    private final Texture emptyToasterTextureLeft = new Texture("empty_cucumber_toaster_animation_left.png");
    private final Texture fullToasterTextureRight = new Texture("full_cucumber_toaster_animation_right.png");
    private final Texture fullToasterTextureLeft = new Texture("full_cucumber_toaster_animation_left.png");
    private final Texture eatingToasterRight = new Texture("eating_cucumber_toaster_right.png");
    private final Texture eatingToasterLeft = new Texture("eating_cucumber_toaster_left.png");
